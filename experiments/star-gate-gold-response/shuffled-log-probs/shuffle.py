...
def main(args: DictConfig) -> None:
    ...
    with open(f"{SIMULATION_PATH}/{VERSION_1_ESFT}/{args.qa_model.shortname}/{args.split.name}.json", 'r') as f:
    ...
    with open(f"{SIMULATION_PATH}/{VERSION_1_ESFT}/{args.qa_model.shortname}/{args.split.name}-shuffled.json", 'w') as f:
