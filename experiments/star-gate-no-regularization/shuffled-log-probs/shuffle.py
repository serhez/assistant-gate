...
def main(args: DictConfig) -> None:
    ...
    with open(f"{SIMULATION_PATH}/{VERSION_3_QSFT}/{args.qa_model.shortname}/{args.split.name}.json", 'r') as f:
    ...
    with open(f"{SIMULATION_PATH}/{VERSION_3_QSFT}/{args.qa_model.shortname}/{args.split.name}-shuffled.json", 'w') as f:
